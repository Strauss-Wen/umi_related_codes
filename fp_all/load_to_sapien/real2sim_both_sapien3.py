...
def main(gp_T: np.ndarray, fp_T: np.ndarray):
    ...
    # actor_builder.add_convex_collision_from_file("/mnt/data/cup_both/mesh/cup_resized.obj")
    # actor_builder.add_collision_from_file("/mnt/data/mesh/cup.obj")
    
    # actor_builder.add_visual_from_file("/mnt/data/cup_both/mesh/cup_resized.dae")

    actor_builder.add_visual_from_file("/mnt/data/mesh/cup.obj")
    cup = actor_builder.build_kinematic("cup")


    # actor_builder.add_convex_collision_from_file("/mnt/data/umi_gripper_mesh/umi_gripper.obj")
    # actor_builder.add_collision_from_file("/mnt/data/mesh/gripper.obj")

    # actor_builder.add_visual_from_file("/mnt/data/umi_gripper_mesh/umi_gripper.dae")
    actor_builder.add_visual_from_file("/mnt/data/mesh/gripper.obj")
...
if __name__ == '__main__':
    gripper_T_path = sys.argv[1] # path to .npy file
    object_T_path = sys.argv[2]

    gripper_T = np.load(gripper_T_path)
    object_T = np.load(object_T_path)

    main(gripper_T, object_T)