...
try:
    while True:
        ...
        if RecordStream:
            ...
            # image_path_depth_unaligned = os.path.join(subfolder_depth_unaligned, f"{framename:06d}.png")
            # image_path_rgb_unaligned = os.path.join(subfolder_rgb_unaligned, f"{framename:06d}.png")
