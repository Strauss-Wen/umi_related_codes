...
class XArm7(BaseAgent):
    ...
    def _controller_configs(self) -> Dict[str, Union[ControllerConfig,]]:
        ...
        arm_force_limit = 20
        '''
        gripper_joint_names = ["left_inner_knuckle", "left_outer_knuckle", "left_finger", "right_inner_knuckle", "right_outer_knuckle", "right_finger"]
        gripper_joint_names = ["left_finger", "right_finger"]
        '''
        gripper_joint_names = ["left_inner_knuckle_joint", "left_outer_knuckle_joint", "left_finger_joint", "right_inner_knuckle_joint", "right_outer_knuckle_joint", "right_finger_joint"]
        # -------------------------------------------------------------------------- #
        # Arm
        # -------------------------------------------------------------------------- #
